...
# For the posterior flagellum we use the model from Suzuki-Tellier et. al 2024
...
excavate = MicroSwimmer([body, anterior, posterior])
...
# Recreate the excavate at the origin for the feeding calculation
excavate = MicroSwimmer([body, anterior, posterior])
